...
//        print("deinit TLAlbumPopView")
    ...
    override open func awakeFromNib() {
        ...
        self.tableView.register(UINib(nibName: "TLCollectionTableViewCell", bundle: TLBundle.resourceBundle(classCoder: TLCollectionTableViewCell.classForCoder())), forCellReuseIdentifier: "TLCollectionTableViewCell")
    }
